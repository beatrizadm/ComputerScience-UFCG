...
/**
 * Guarda o historico de um jogo, para usarmos em interfaces.
 *
 */
public class HistoricoDeJogo {
	...
	private class SituacaoNoJogo {
		...
		@Override
		public String toString() {
			return "  " + this.jogador1.getNome() + " : " + jogadaJ1.toString() + ", mao: "
					+ maoJ1.toString() + "\n  " + this.jogador2.getNome() + " : " + jogadaJ2.toString() + ", mao: "
					+ maoJ2.toString() + "\n  " + 
					"MESA: " + mesa.toString();
		}
	}
